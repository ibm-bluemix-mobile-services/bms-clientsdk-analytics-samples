 ...
 */
public class LoginActivity extends AppCompatActivity implements AppLaunchActions {
    ...
    @Override
    public void onFeaturesReceived(String s) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                showProgress(false);
                finish();
                Intent i = new Intent(getBaseContext(),CustomViewIconTextTabsActivity.class);
                startActivity(i);
            }
        });
