...
class LoggerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func triggerNullPointer(_ sender: UIButton) {
        
        Analytics.log(metadata: ["buttonPressed": "triggerNullPointer"])
        
        let nullVariable: String? = nil
        print(nullVariable!)
    }
    
    @IBAction func triggerOutOfBounds(_ sender: UIButton) {
        
        Analytics.log(metadata: ["buttonPressed": "triggerOutOfBounds"])
