...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        BMSClient.sharedInstance.initialize(bluemixRegion: "localhost:8000")
        
        // IMPORTANT: Replace the apiKey parameter with a key from a real Analytics service instance
        Analytics.initialize(appName: "TestAppiOSkrish", apiKey: "2bd5ad2a-ff2a-459c-bf0a-9d2ec90a538e", hasUserContext: true, collectLocation: true, deviceEvents: DeviceEvent.lifecycle, DeviceEvent.network)
        //Analytics.userIdentity = "krishnendu"
