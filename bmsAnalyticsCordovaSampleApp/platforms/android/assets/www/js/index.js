...
onDeviceReady: function() {
    ...
    BMSAnalytics.initialize(applicationName, apiKey, hasUserContext,false deviceEvents);//collectLocation,
    console.log('Bluemix Mobile Analytics initialized');
    //BMSAnalytics.overrideServerHost="http://10.0.2.2:8000";
    ...
    "getLogLevel":function()  {
        ...
        BMSLogger.getLogLevel(function(success) {
                              statusText.innerHTML ="Current Logging Level "+success+ "logLocation called";
                              },
                              function (failure) {
